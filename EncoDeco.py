...
input_img = Input(shape=(320,240,3))
...
for epoch in range(1,300):
    ...
    if(epoch%1==0):
        ...
        # temp[:,:,1]=temp[:,:,0]
        # temp[:,:,2]=temp[:,:,0]
        temp[:, :128,1:2] = x_test[0,:,:,1:2]
        temp[:, 128:128*2,1:2] = y_test[0,:,:,1:2]
        temp[:, 128*2:,1:2] = decoded_imgs[0,:,:,1:2]

        temp[:, :128,2:3] = x_test[0,:,:,2:3]
        temp[:, 128:128*2,2:3] = y_test[0,:,:,2:3]
        temp[:, 128*2:,2:3] = decoded_imgs[0,:,:,2:3]
